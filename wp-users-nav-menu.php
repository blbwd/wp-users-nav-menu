<?php
/*
Plugin Name: Nav Menu Users List
Plugin URI: http://www.sanjaybhowmick.com/
...
<div id="userlinks-menu-metabox" class="posttypediv">
  <div id="tabs-panel-users" class="tabs-panel tabs-panel-active">
    <ul id ="userlinks-checklist" class="categorychecklist form-no-clear">
      ...
      <li>
        ...
        <?php echo $u4wpm_user->display_name ?> </label>
  ...
  <p class="button-controls"> <span class="list-controls"> <a href="/wordpress/wp-admin/nav-menus.php?page-tab=all&amp;selectall=1#userlinks-menu-metabox" class="select-all">Select All</a> </span> <span class="add-to-menu">
    ...
    <span class="spinner"></span> </span> </p>
</div>
<?php }
        }
